...
public class AgentEventCallback implements EventCallback {
	 ...
	 * 
	 * @param event events which is sent from the Raspberry Pi to IoT
	 * (non-Javadoc)
	 * 
	 * @see
	 * com.ibm.iotf.client.app.EventCallback#processEvent(com.ibm.iotf.client.
	 * app.Event)
	 */
	@Override
	 ...
	 * of ambulance and adds it to the ambulances hashmap
	 * @param event events which is sent from Raspberry Pi to IoT
	 */
	public void addAmbulance(Event event) {
		...
		try {
			...
			// Add the current position of ambulance with the given id to the ambulances hashmap
			// Set the state of ambulance (free or not)
